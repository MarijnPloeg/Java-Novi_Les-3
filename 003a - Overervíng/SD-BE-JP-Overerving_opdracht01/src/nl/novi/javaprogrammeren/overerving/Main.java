...
public class Main {
    ...
    public static void main (String[] args) {
        ...
        Cat wiskers = new Cat("Manuel", "CatsOnly", Species.Cat, PreferredEnvironment.Inside);
        wiskers.eat();
        wiskers.makeSound();
        wiskers.Move();
        wiskers.sleep();
        ...
        Dog tammie = new Dog("Micheal", "Oisters", Species.Dog);
        tammie.eat();
        tammie.makeSound();
        tammie.Move();
        tammie.sleep();
        ...
        Lion simba = new Lion("Artis", "07-12-2020", "Africa", 4 );
        simba.eat();
        simba.makeSound();
        simba.sleep();
        simba.Move();
